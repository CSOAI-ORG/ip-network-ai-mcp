...
mcp = FastMCP("ip-network-ai", instructions="MEOK AI Labs MCP Server")
...
def subnet_calculator(network: str, api_key: str = "") -> dict[str, Any]:
    ...
    Args:
        network (str): The network to analyze or process.
        api_key (str): The api key to analyze or process.
...
def cidr_to_range(cidr: str, api_key: str = "") -> dict[str, Any]:
    ...
    Args:
        cidr (str): The cidr to analyze or process.
        api_key (str): The api key to analyze or process.
...
def dns_lookup_data(hostname: str, api_key: str = "") -> dict[str, Any]:
    ...
    Args:
        hostname (str): The hostname to analyze or process.
        api_key (str): The api key to analyze or process.
